			...
			<div className="container-fluid mt-3">
				...
				<div className="row d-flex justify-content-center">
					<div className="col-sm-8 m-4 pl-5 justify-content-center d-flex flex-column">
						...
						{paragraph('<span>But Lens ran out of money before we were able to publicly launch. We weren’t able to raise money, and having lived on the Ramen Noodle diet for 3 years, I decided to move on to the next thing.</span>')}
						{paragraph('<span>After Lens, I joined my current company, RS21, a data science and visualization company. I started out at RS21 as a Project Manager, managing RS21’s national labs portfolio (I can’t share too much about that work publicly). As I was finishing up those contracts, the company was beginning to launch 2 initiatives that I have since taken the lead on.</span>')}
						{paragraph('<span>One initiative is to build an internal data science platform, so our team can build performant applications for clients much quicker. I’ve led a group of 20 data scientists, developers, and designers, to lay out a roadmap for this platform, and we’ve already built micro-service functionality around our data warehouse, acquisition, transformation, preparation, and geospatial mapping capabilities.</span>')}
						{paragraph('<span>The second initiative I’ve taken the lead on is building RS21’s first product. RS21 has traditionally built highly customized software. Using Design Thinking methodology, I’m helping RS21 iteratively develop and test product hypotheses around how we can take our existing capabilities and build a generalized product that can reach more people at a lower price point. Having been at this early stage of product discovery before, I’m focusing on quickly validating product hypotheses before expending unnecessary resources. We do that validation by rapidly iterating through exploratory product research, prototyping, and what I’m calling “buy tests,” realistic product pitches where we ask potential customers to make a financial commitment to be part of a pilot program.</span>')}
						{paragraph('<span>I’m not sure what the future entails, but I’m sure it will entail creating technology that serves reals needs for real people.</span>')}
