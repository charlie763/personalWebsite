  ...
  <div class="row justify-content-between py-3">
    ...
    <dl>
      <dt class="display-title primary-text">Personal Website
        <span class="secondary-text title-subtitle ml-3">Last Updated: Jun 08, 2020</span>
      </dt>
    ...
    <dl>
      <dt class="display-title primary-text">Checkers
        <span class="secondary-text title-subtitle ml-3">Last Updated: Jul 14, 2020</span>
      </dt>
